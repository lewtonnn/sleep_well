    ...
    return (
      <div class="welcome-main">
        <div class="container welcome">
          <img src={moon} alt="" class="welcome__moon" />
          <img src={neptune} alt="" class="welcome__neptune" />
          <img src={star} alt="" class="welcome__star" />
          <div class="welcome__button" onClick={() => goToPage("2")}>
            <p class="button__text">Go to Dashboard</p>
            <div class="button__circle">
              <img src={arrow} alt="" class="button__arrow" />
            </div>
          </div>
          <div class="welcome__text-block">
            <h1 class="welcome__h1">How to Sleep Well Every Day</h1>
            <p class="welcome__paragraph first">
            ...
            <img src={welcomeRoom} alt="Comfy bedroom" class="welcome__pic" />
            ...
            <p class="welcome__paragraph last">
